...
"How should I model a Transaction?"
    ...
    ↑ Check: project requirements (audit, precision requirements)
...
| Aggregate boundaries | Project model | What must be consistent together? |
| Validation rules | Business rules | What constraints apply? |
