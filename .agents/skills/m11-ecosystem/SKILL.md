...
"Which HTTP framework should I use?"
    ...
    ↑ Check: project requirements (latency, throughput needs)
    ↑ Check: Team expertise (familiarity with framework)
```

| Question | Trace To | Ask |
|----------|----------|-----|
| Framework choice | Project requirements | What constraints matter? |
| Library vs build | Project configuration | What's the deployment model? |
| API design | `m09-domain` | Who are the consumers? |
